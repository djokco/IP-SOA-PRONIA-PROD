...
<xsl:stylesheet version="1.0" xmlns:oraxsl="http://www.oracle.com/XSL/Transform/java"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.0(XSLT Build 140529.0700.0211) AT [MON JAN 09 17:14:17 ICT 2017].-->
  </oracle-xsl-mapper:schema>
      ...
      <tns:PNCALCSet>
        <xsl:for-each select="/ns0:Pronia3CalcStatusCollection/ns0:Pronia3CalcStatus">
          <tns:IPPN_CALC_STATUS action="Change">
            ...
            <tns:SITEID>
              <xsl:choose>
                <xsl:when test="/ns0:Pronia3CalcStatusCollection/ns0:Pronia3CalcStatus/ns0:unit = 'BCL'">
