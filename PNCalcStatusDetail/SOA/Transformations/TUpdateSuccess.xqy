...
declare function local:funcTupdatesuccess($InputVariable.Pronia3CalcStatusDetailCollection as element() (:: schema-element(dbp:Pronia3CalcStatusDetailCollection) ::), 
...
local:funcTupdatesuccess($InputVariable.Pronia3CalcStatusDetailCollection, $Response)
