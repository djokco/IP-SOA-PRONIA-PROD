...
declare function local:funcT_updatepronia3calcstatusdetail_success($InputVariable.Pronia3CalcStatusDetailCollection as element() (:: schema-element(dbp:Pronia3CalcStatusDetailCollection) ::), 
...
local:funcT_updatepronia3calcstatusdetail_success($InputVariable.Pronia3CalcStatusDetailCollection, $Response)
