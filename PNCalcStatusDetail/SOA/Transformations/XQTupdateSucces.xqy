...
declare function local:funcXqtupdatesucces($InputVariable.Pronia3CalcStatusDetailCollection as element() (:: schema-element(dbp:Pronia3CalcStatusDetailCollection) ::), 
...
local:funcXqtupdatesucces($InputVariable.Pronia3CalcStatusDetailCollection, $fault)
